...
from guis import window, acquisition, data, alignment, reconstructor, plugin, submit, settings
from plugins import plugin as plugin_exe
from acquisition_schemes import acquire
from plotter.plotter import ProcessPlotter
